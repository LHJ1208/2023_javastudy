...
//이벤트 핸들러 : 리스너에 전달된 이벤트를 실제로 처리할 수 있도록 이벤트 리스너에 포함되어 있는 메서드(추상 메서드)
//	즉 발생된 이벤트 객체를 받아서 실제적을 처리해주는 기능을 하는 메서드

//ActionEvent : 컴포넌트를 눌렀거나 선택되어있을 때, Enter키를 눌렀을 때 발생하는 이벤트
...
//		System.out.println("버튼을 눌렀내요");
		JButton obj = (JButton) e.getSource();
		if (obj == jb1) {
			System.out.println("입력1이 눌렀내");
		} else if (obj == jb2) {
			System.out.println("입력2이 눌렀내");
		} else if (obj == jb3) {

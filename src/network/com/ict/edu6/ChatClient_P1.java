...
public class ChatClient_P1 extends JPanel {
	private ChatClient_MF parent;
	 ...
	 * Create the panel.
	 */
	public ChatClient_P1(ChatClient_MF parent) {
		this.parent = parent;
		...
		centerImg.setIcon(new ImageIcon(ChatClient_P1.class.getResource("/images/talk.png")));

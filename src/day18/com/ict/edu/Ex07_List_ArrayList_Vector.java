...
public class Ex07_List_ArrayList_Vector {
...
//	ArrayList와 Vector 사용법은 같다.
	...
	public static void main(String[] args) {
		...
		// search(), elementAt(), firstElement(), lastElement() : ArrayList에는 없음
		// elementAt(), firstElement(), lastElement() : Vector 에는 있음
		...
		// 삭제 : remove //중복된 것이 있으면 처음것만 삭제한다.
		list.remove("박지성");
		System.out.println(list);
		System.out.println();

...
public class Ex07_LocalDate {
	public static void main(String[] args) {
		...
		System.out.println("getYear() : " + cDate.getYear()); // 년도 2023
		System.out.println("getMonth() : " + cDate.getMonth()); // 월 (JAN, FEB, ... , MAY, ...)
		System.out.println("getMonthValue() : " + cDate.getMonthValue()); // 월 (1, 2, 3, ...)
		System.out.println("getDayOfYear() : " + cDate.getDayOfYear()); // 년의 몇번째 일
		System.out.println("getDayOfMonth() : " + cDate.getDayOfMonth()); // 월의 몇번째 일
		System.out.println("getDayOfWeek() : " + cDate.getDayOfWeek()); // 요일 (MONDAY, TUESDAY, ...)
		...
		LocalDate eDate = LocalDate.of(2023, 07, 22);
